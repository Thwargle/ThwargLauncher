...
namespace ThwargFilter
{
    public class LaunchControl
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ThwargFilterInfo GetThwargFilterInfo()
        {
            var info = new ThwargFilterInfo();
            var assembly = System.Reflection.Assembly.GetExecutingAssembly();
            info.ThwargFilterVersion = assembly.GetName().Version.ToString();
            info.ThwargFilterPath = assembly.Location;
            return info;
        }
        /// <summary>
        /// Called by ThwargLauncher
