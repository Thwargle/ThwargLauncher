...
namespace ThwargFilter
{
    class Heartbeat
    {
        ...
        private ThwargFilterCommandParser _cmdParser = null;
        ...
        public static void SetCommandParser(ThwargFilterCommandParser parser) { theHeartbeat._cmdParser = parser; }
        ...
        {
            // Note: "Filter.Shared.PostMessageTools.SendMsg" does not work
