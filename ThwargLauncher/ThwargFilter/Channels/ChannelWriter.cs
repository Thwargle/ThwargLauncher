...
namespace ThwargFilter.Channels
{
    ...
    /// For commands passed between ThwargLauncher application and the ThwargFilter dll inside the game
    /// This code is called both from ThwargFilter inside the game
    /// And from the ThwargLauncher application (which loads its own copy of ThwargFilter inside itself)
    /// </summary>
